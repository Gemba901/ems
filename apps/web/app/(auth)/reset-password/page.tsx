...
import { Eye, EyeOff, Check, ArrowRight, ArrowLeft, Loader2, AlertCircle, CheckCircle2, KeyRound } from "lucide-react";
      ...
      >
        {done ? (
          ...
          <div className="flex flex-col items-center text-center">
            ...
            >
              <ArrowLeft className="h-4 w-4 mr-1.5" /> Request a new link
            </Link>
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-y-3">
                <div className={`flex items-center text-xs ${validations.length ? "text-blue-600" : "text-slate-400"}`}>
                  <Check className={`h-3 w-3 mr-2 ${validations.length ? "opacity-100" : "opacity-40"}`} /> 12+ Characters
                </div>
              ...
              >
                {loading ? (
                  ...
                  <>
                    Reset Password <ArrowRight className="h-4 w-4 ml-2 group-hover:translate-x-1 transition-transform" />
                  </>
                )}
              </button>
            </form>
