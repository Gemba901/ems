...
import {
  X, Users, Check, CheckCircle2, Loader2, Edit2, Trash2, Globe2, Lock, RefreshCw,
} from "lucide-react";
import {
...
export function AgendaItemBody({
  item, token, isAdmin, onChanged, onEditEvent, onDeleteVisit, onUnblock, onClose,
}: {
  item: AgendaItem;
  token: string;
  isAdmin: boolean;
