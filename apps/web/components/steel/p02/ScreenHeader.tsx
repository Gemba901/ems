...
// Shared header for the P02 S1-S5 workflow screens: back link + icon badge
// + title/subtitle, matching the pattern established in components/steel/p01/ScreenHeader.tsx.
export function ScreenHeader({
  icon: Icon, title, subtitle, backHref = "/steel/p02", backLabel = "Back to Sourcing Orders", rightContent,
}: Props) {
  return (
