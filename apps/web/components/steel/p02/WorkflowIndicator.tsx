...
// Shared S1-S5 workflow pill strip for P02, mirroring
// components/steel/p01/WorkflowIndicator.tsx. Done/active/upcoming is
// derived purely from doneCount/activeIndex — callers decide those two
// numbers from the real server stage, so this component has no stage logic
// of its own.
