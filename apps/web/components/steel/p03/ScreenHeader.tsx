...
// Shared header for the P03 S1-S3 workflow screens: back link + icon badge
// + title/subtitle. Mirrors components/steel/p02/ScreenHeader.tsx.
export function ScreenHeader({
  icon: Icon, title, subtitle, backHref = "/steel/p03", backLabel = "Back to Material Intakes", rightContent,
}: Props) {
  return (
